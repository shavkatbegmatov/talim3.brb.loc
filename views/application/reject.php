<div class="card">
    <form class="row g-0" method="POST" action="/application/reject/<?php echo $data['id']; ?>">
        <div class="card-body">
            <h2 class="mb-4">Отклонить заявку</h2>
            ...
            <div>
                <label for="reason" class="form-label required">Причина отклонения</label>
                <textarea type="text" class="form-control" id="reason" name="reason" placeholder="Введите причину отклонения"></textarea>
            </div>

            <div class="btn-list mt-3">
                <button type="submit" class="btn btn-primary" onclick="return confirm('Вы точно хотите отказать эту заявку?');">
                    Отклонить заявку
                </button>
